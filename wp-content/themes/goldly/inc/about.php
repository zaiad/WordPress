...
function goldly_about_menu() {
	add_theme_page( esc_html__( 'About Theme', 'goldly' ), esc_html__( 'About Theme', 'goldly' ), 'edit_theme_options', 'goldly-about', 'goldly_about_display' );
}
add_action( 'admin_menu', 'goldly_about_menu' );

function goldly_about_display(){
	?>
		...
		<div class="goldly_about_title">
			...
			<div class="goldly_about_theme">
				<div class="goldly_about_description">
					<p>
					Goldly is a clean, modern, user friendly, responsive and highly customizable WordPress Theme. you’ll easily find the design of this theme impressive and suitable for your Website. This goldly WordPress theme, carries an abundance of crucial features and functionalities. For instance, featured slider, featured Section, About Section, Our Portfolio, Our team Section, Testimonial Slider, Our Services, Our Sponsors, Sticky Header, Social Information, Sidebar, Excerpt Options, and many more. All of these highly-customizable features and sections are completely responsive and absolutely easy to customize. </p>
					<div class="action">
						<a href="https://xeeshop.com/goldly/" class="button button-secondary"><?php echo esc_html( 'View Demo', 'goldly' ); ?></a>

						<a href="https://www.xeeshop.com/goldly-documentation/" target="_blank" class="button button-primary" ><?php echo esc_html( 'Theme Instructions', 'goldly' ); ?></a>

						<a href="#" class="button button-secondary"><?php echo esc_html( 'Rate this theme', 'goldly' ); ?></a>

						<a href="https://www.xeeshop.com/product/goldly-pro/" target="_blank" class="button button-primary"><?php echo esc_html( 'Compare free Vs Pro',  'goldly' ); ?></a>
